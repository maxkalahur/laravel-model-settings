...
use MaxKalahur\LaravelModelSettings\Exceptions\SettingKeyIsAbsentException;
use MaxKalahur\LaravelModelSettings\Exceptions\SettingWrongDataTypeException;
